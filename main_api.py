...
from Predictors.LSTM import predict_stock_price
...
def create_graph(df, stock_code):
...
def company_info(stock_code):
    ...
    graph_html = create_graph(df, stock_code)
